...
static const char qt_meta_stringdata_Retriever[] = {
    "Retriever\0\0,\0updateRowHeader(int,int)\0"
    "tblCellChanged()\0"
};

const QMetaObject Retriever::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata_Retriever,
      qt_meta_data_Retriever, 0 }
};
...
int Retriever::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: updateRowHeader((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: tblCellChanged(); break;
        default: ;
        }
        _id -= 2;
    }
