...
#include "../../../../Common/DSCORE/videorender.h"
...
static const char qt_meta_stringdata_VideoRender[] = {
    "VideoRender\0"
};

const QMetaObject VideoRender::staticMetaObject = {
    { &Filter::staticMetaObject, qt_meta_stringdata_VideoRender,
      qt_meta_data_VideoRender, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VideoRender::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoRender))
