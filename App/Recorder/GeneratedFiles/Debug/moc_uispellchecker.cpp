...
** Meta object code from reading C++ file 'uispellchecker.h'
**
...
#include "../../src/uispellchecker.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'uispellchecker.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_SpellChecker[] = {
    "SpellChecker\0\0btnApply_clicked()\0"
};

const QMetaObject SpellChecker::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SpellChecker,
