...
static const char qt_meta_stringdata_Find[] = {
    "Find\0\0btnFind_Clicked()\0"
};

const QMetaObject Find::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Find,
      qt_meta_data_Find, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Find::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Find))
