...
static const char qt_meta_stringdata_SQLiteDataBase[] = {
    "SQLiteDataBase\0"
};

const QMetaObject SQLiteDataBase::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SQLiteDataBase,
      qt_meta_data_SQLiteDataBase, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SQLiteDataBase::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SQLiteDataBase))
        return static_cast<void*>(const_cast< SQLiteDataBase*>(this));
